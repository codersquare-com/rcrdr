package as3wavesound {
	...
	public class WavSoundChannel extends EventDispatcher {
		...
		public static function isWavFile(fileName:String): Boolean 
		{
			var expression:String = fileName.substring(fileName.length - 3, fileName.length);
			return "wav" == expression;
		}
		
		public static function isMp3File(fileName:String): Boolean 
		{
			var expression:String = fileName.substring(fileName.length - 3, fileName.length);
			return "mp3" == expression;
		}
	}
}